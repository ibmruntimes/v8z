...
void MemoryAllocator::ReportStatistics() {
  ...
  PrintF("\x20\x20\x63\x61\x70\x61\x63\x69\x74\x79\x3a\x20\x25" V8_PTR_PREFIX
         ...
         "\x64"
         "\x2c\x20\x61\x76\x61\x69\x6c\x61\x62\x6c\x65\x3a\x20\x25\x25\x6c\x84\xa\xa",
...
bool NewSpace::SetUp(int reserved_semispace_capacity,
  ...
  LOG(heap()->isolate(), NewEvent("\x49\x6e\x69\x74\x69\x61\x6c\x43\x68\x75\x6e\x6b", chunk_base_, chunk_size_));
...
void NewSpace::TearDown() {
  ...
  LOG(heap()->isolate(), DeleteEvent("\x49\x6e\x69\x74\x69\x61\x6c\x43\x68\x75\x6e\x6b", chunk_base_));
  ...
  if (to_space_.GrowTo(new_capacity)) {
    ...
    if (!from_space_.GrowTo(new_capacity)) {
      ...
      if (!to_space_.ShrinkTo(from_space_.Capacity())) {
        ...
        V8::FatalProcessOutOfMemory("\x46\x61\x69\x6c\x65\x64\x20\x74\x6f\x20\x67\x72\x6f\x77\x20\x6e\x65\x77\x20\x73\x70\x61\x63\x65\x2e");
      }
    }
  }
  ...
  if (rounded_new_capacity < Capacity() &&
    ...
    if (!from_space_.ShrinkTo(rounded_new_capacity)) {
      ...
      if (!to_space_.GrowTo(from_space_.Capacity())) {
        // We are in an inconsistent state because we could not
        // commit/uncommit memory from new space.
        V8::FatalProcessOutOfMemory("\x46\x61\x69\x6c\x65\x64\x20\x74\x6f\x20\x73\x68\x72\x69\x6e\x6b\x20\x6e\x65\x77\x20\x73\x70\x61\x63\x65\x2e");
      }
    }
  }
  DCHECK_SEMISPACE_ALLOCATION_INFO(allocation_info_, to_space_);
...
static void ReportCodeKindStatistics(int* code_kind_statistics) {
  ...
  for (int i = 0; i < Code::NUMBER_OF_KINDS; i++) {
    if (code_kind_statistics[i] > 0) {
      PrintF("\x20\x20\x20\x20\x20\x6c\x60\xf2\xf0\xa2\x3a\x20\x6c\xf1\xf0\x84\x20\x62\x79\x74\x65\x73\xa",
...
static void ReportHistogram(Isolate* isolate, bool print_spill) {
  ...
  for (int i = 0; i <= LAST_TYPE; i++) {
    if (isolate->heap_histograms()[i].number() > 0) {
      PrintF("\x20\x20\x20\x20\x6c\x60\xf3\xf4\xa2\x6c\xf1\xf0\x84\x20\x28\x6c\xf1\xf0\x84\x20\x62\x79\x74\x65\x73\x29\xa",
...
#undef INCREMENT
  if (string_number > 0) {
    PrintF("\x20\x20\x20\x20\x6c\x60\xf3\xf4\xa2\x6c\xf1\xf0\x84\x20\x28\x6c\xf1\xf0\x84\x20\x62\x79\x74\x65\x73\x29\xa\xa", "\x53\x54\x52\x49\x4e\x47\x5f\x54\x59\x50\x45", string_number,
           string_bytes);
  }
...
void NewSpace::ReportStatistics() {
  ...
  if (FLAG_heap_stats) {
    ...
    PrintF("\x20\x20\x63\x61\x70\x61\x63\x69\x74\x79\x3a\x20\x25" V8_PTR_PREFIX
           "\x64"
           "\x2c\x20\x61\x76\x61\x69\x6c\x61\x62\x6c\x65\x3a\x20\x25" V8_PTR_PREFIX "\x64\x2c\x20\x25\x25\x6c\x84\xa",
           Capacity(), Available(), static_cast<int>(pct * 100));
    PrintF("\xa\x20\x20\x4f\x62\x6a\x65\x63\x74\x20\x48\x69\x73\x74\x6f\x67\x72\x61\x6d\x3a\xa");
    for (int i = 0; i <= LAST_TYPE; i++) {
      if (allocated_histogram_[i].number() > 0) {
        PrintF("\x20\x20\x20\x20\x6c\x60\xf3\xf4\xa2\x6c\xf1\xf0\x84\x20\x28\x6c\xf1\xf0\x84\x20\x62\x79\x74\x65\x73\x29\xa", allocated_histogram_[i].name(),
...
void PagedSpace::ReportCodeStatistics(Isolate* isolate) {
  ...
  for (int i = 0; i <= CommentStatistic::kMaxComments; i++) {
    ...
    if (cs.size > 0) {
      PrintF("\x20\x20\x20\x6c\x60\xf3\xf0\xa2\x3a\x20\x6c\xf1\xf0\x84\x2f\x6c\xf6\x84\x20\x20\x20\x20\x20\x28\x6c\x84\x29\xa", cs.comment, cs.size, cs.count,
             cs.size / cs.count);
    }
  }
  PrintF("\xa");
...
void LargeObjectSpace::ReportStatistics() {
  ...
  PrintF(
      "\x20\x20\x6e\x75\x6d\x62\x65\x72\x20\x6f\x66\x20\x6f\x62\x6a\x65\x63\x74\x73\x20\x6c\x84\x2c\x20"
...
void Page::Print() {
  ...
  PrintF("\x50\x61\x67\x65\x40\x6c\x97\x20\x69\x6e\x20\x6c\xa2\xa", this->address(),
  ...
  for (HeapObject* object = objects.Next(); object != NULL;
    ...
    PrintF("\x20\x6c\x83\x20", (is_marked ? '\x21' : '\x20'));  // Indent a little.
    if (is_marked) {
  ...
  printf("\x20\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\x2d\xa");
  printf("\x20\x4d\x61\x72\x6b\x65\x64\x3a\x20\x6c\xa7\x2c\x20\x4c\x69\x76\x65\x43\x6f\x75\x6e\x74\x3a\x20\x6c\xa7\xa", mark_size, LiveBytes());
}
