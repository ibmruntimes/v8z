...
void GlobalHandles::PrintStats() {
  ...
  PrintF("\x47\x6c\x6f\x62\x61\x6c\x20\x48\x61\x6e\x64\x6c\x65\x20\x53\x74\x61\x74\x69\x73\x74\x69\x63\x73\x3a\xa");
  PrintF("\x20\x20\x61\x6c\x6c\x6f\x63\x61\x74\x65\x64\x20\x6d\x65\x6d\x6f\x72\x79\x20\x3d\x20\x25" V8_PTR_PREFIX "\x64\x42\xa",
         static_cast<intptr_t>(sizeof(Node)) * total);
  PrintF("\x20\x20\x23\x20\x77\x65\x61\x6b\x20\x20\x20\x20\x20\x20\x20\x3d\x20\x6c\x84\xa", weak);
  PrintF("\x20\x20\x23\x20\x70\x65\x6e\x64\x69\x6e\x67\x20\x20\x20\x20\x3d\x20\x6c\x84\xa", pending);
  PrintF("\x20\x20\x23\x20\x6e\x65\x61\x72\x5f\x64\x65\x61\x74\x68\x20\x3d\x20\x6c\x84\xa", near_death);
  PrintF("\x20\x20\x23\x20\x66\x72\x65\x65\x20\x20\x20\x20\x20\x20\x20\x3d\x20\x6c\x84\xa", destroyed);
  PrintF("\x20\x20\x23\x20\x74\x6f\x74\x61\x6c\x20\x20\x20\x20\x20\x20\x3d\x20\x6c\x84\xa", total);
}


void GlobalHandles::Print() {
  PrintF("\x47\x6c\x6f\x62\x61\x6c\x20\x68\x61\x6e\x64\x6c\x65\x73\x3a\xa");
  for (NodeIterator it(this); !it.done(); it.Advance()) {
    PrintF("\x20\x20\x68\x61\x6e\x64\x6c\x65\x20\x6c\x97\x20\x74\x6f\x20\x6c\x97\x6c\xa2\xa",
           reinterpret_cast<void*>(it.node()->location()),
           reinterpret_cast<void*>(it.node()->object()),
           it.node()->IsWeak() ? "\x20\x28\x77\x65\x61\x6b\x29" : "");
  }
}
