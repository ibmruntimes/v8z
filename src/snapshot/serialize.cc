...
#define SIXTEEN_CASES(byte_code)          \
  ...
  FOUR_CASES(byte_code + 12)
    ...
    defined(V8_TARGET_ARCH_PPC) || defined(V8_TARGET_ARCH_S390)|| V8_OOL_CONSTANT_POOL
    ...
    defined(V8_TARGET_ARCH_MIPS64) || defined(V8_TARGET_ARCH_S390)|| defined(V8_TARGET_ARCH_PPC)
