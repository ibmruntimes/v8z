...
class MacroAssembler: public Assembler {
 public:
  ...
  void Pop(Register src1,
           ...
           Register src4,
           Register src5) {
    LoadP(src5, MemOperand(sp));
    LoadP(src4, MemOperand(sp, sp, kPointerSize));
