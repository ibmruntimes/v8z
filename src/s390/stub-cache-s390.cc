...
static void ProbeTable(Isolate* isolate,
  ...
  DCHECK(kPointerSizeLog2 == StubCache::kCacheIndexShift);
#endif
  __ AddP(base_addr, offset_scratch);
...
void ElementHandlerCompiler::GenerateLoadDictionaryElement(
  ...
  __ UntagAndJumpIfNotSmi(r8, key, &miss);
  __ LoadP(r6, FieldMemOperand(receiver, JSObject::kElementsOffset));
  __ LoadFromNumberDictionary(&slow, r6, key, r2, r8, r5, r7);
  __ Ret();
