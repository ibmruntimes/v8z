...
void LOperand::PrintTo(StringStream* stream) {
  ...
  switch (kind()) {
    ...
    case UNALLOCATED:
      ...
      stream->Add("\x76\x6c\x84", unalloc->virtual_register());
      if (unalloc->basic_policy() == LUnallocated::FIXED_SLOT) {
        stream->Add("\x28\x3d\x6c\x84\x53\x29", unalloc->fixed_slot_index());
        break;
      }
      switch (unalloc->extended_policy()) {
        ...
        case LUnallocated::FIXED_REGISTER: {
          ...
          if (reg_index < 0 ||
            ...
            stream->Add("\x28\x3d\x69\x6e\x76\x61\x6c\x69\x64\x5f\x72\x65\x67\x23\x6c\x84\x29", reg_index);
          } else {
            const char* register_name =
                Register::AllocationIndexToString(reg_index);
            stream->Add("\x28\x3d\x6c\xa2\x29", register_name);
          }
          break;
        }
        case LUnallocated::FIXED_DOUBLE_REGISTER: {
          ...
          if (reg_index < 0 ||
            ...
            stream->Add("\x28\x3d\x69\x6e\x76\x61\x6c\x69\x64\x5f\x64\x6f\x75\x62\x6c\x65\x5f\x72\x65\x67\x23\x6c\x84\x29", reg_index);
          } else {
            const char* double_register_name =
                DoubleRegister::AllocationIndexToString(reg_index);
            stream->Add("\x28\x3d\x6c\xa2\x29", double_register_name);
          }
          break;
        }
    ...
    case CONSTANT_OPERAND:
      stream->Add("\x5b\x63\x6f\x6e\x73\x74\x61\x6e\x74\x3a\x6c\x84\x5d", index());
      break;
    case STACK_SLOT:
      stream->Add("\x5b\x73\x74\x61\x63\x6b\x3a\x6c\x84\x5d", index());
      break;
    case DOUBLE_STACK_SLOT:
      stream->Add("\x5b\x64\x6f\x75\x62\x6c\x65\x5f\x73\x74\x61\x63\x6b\x3a\x6c\x84\x5d", index());
      break;
    case REGISTER: {
      int reg_index = index();
      if (reg_index < 0 || reg_index >= Register::kMaxNumAllocatableRegisters) {
        stream->Add("\x28\x3d\x69\x6e\x76\x61\x6c\x69\x64\x5f\x72\x65\x67\x23\x6c\x84\x7c\x52\x29", reg_index);
      } else {
        stream->Add("\x5b\x6c\xa2\x7c\x52\x5d", Register::AllocationIndexToString(reg_index));
      }
      break;
    }
    case DOUBLE_REGISTER: {
      ...
      if (reg_index < 0 ||
          reg_index >= DoubleRegister::kMaxNumAllocatableRegisters) {
        stream->Add("\x28\x3d\x69\x6e\x76\x61\x6c\x69\x64\x5f\x64\x6f\x75\x62\x6c\x65\x5f\x72\x65\x67\x23\x6c\x84\x7c\x52\x29", reg_index);
      } else {
        stream->Add("\x5b\x6c\xa2\x7c\x52\x5d",
                    DoubleRegister::AllocationIndexToString(reg_index));
      }
      break;
    }
...
void LEnvironment::PrintTo(StringStream* stream) {
  stream->Add("\x5b\x69\x64\x3d\x6c\x84\x7c", ast_id().ToInt());
  if (deoptimization_index() != Safepoint::kNoDeoptimizationIndex) {
    stream->Add("\x64\x65\x6f\x70\x74\x5f\x69\x64\x3d\x6c\x84\x7c", deoptimization_index());
  }
  stream->Add("\x70\x61\x72\x61\x6d\x65\x74\x65\x72\x73\x3d\x6c\x84\x7c", parameter_count());
  stream->Add("\x61\x72\x67\x75\x6d\x65\x6e\x74\x73\x5f\x73\x74\x61\x63\x6b\x5f\x68\x65\x69\x67\x68\x74\x3d\x6c\x84\x7c", arguments_stack_height());
